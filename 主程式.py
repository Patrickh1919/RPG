...
# instantiat people
player1 = Person('Valos:', 3260, 300, 60, 34, player_spells, player_items) #因為在game裡person 有幾樣這邊就必須要幾樣
player2 = Person('Nick :', 4160, 311, 60, 34, player_spells, player_items)
...
while running:
       ...
       for  player in players:
            ...
            if index == 0:
                   ...
                   player.reduce_mp(spell.cost) #只要ＭＰ扣player1的話
                   ...
                   player.choose_item()
                   item_choice = int(input('    Choose item: ')) - 1 #python自動認為1為0 所以玩家選擇1時python會認為選擇的是2選項
       ...
       for enemy in enemies :
              ...
              if enemy_choice == 0:
                     ...
                     print(enemy.name.replace(' ','') + " attcks " + players[target].name.replace(' ','') + "for", enemy_dmg)
                     ...
                     if spell.type == "white":
                            ...
                            print(bcolors.OKBLUE + spell.name + ' heal '+ enemy.name.replace(' ','') +' for', str(magic_dmg),
                                  'HP . ' + bcolors.ENDC)
                            ...
                            print(bcolors.OKBLUE + '\n' + enemy.name.replace(' ','') + "'s " + spell.name + " deals", str(magic_dmg),
                                  "point of damage to " + players[target].name.replace(' ', '') + bcolors.ENDC)
